...
--
$strsql = "CREATE TABLE 'users' ('username' char(8) NOT NULL,'passcode' char(8) NOT NULL,'userflag' int(11) DEFAULT NULL,'ID' int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1;";
$result = $mysqli->query($strsql) or die("SQL execuation fails.");


INSERT INTO 'users' ('username', 'passcode', 'userflag', 'ID') VALUES('admin', 'admin123', 0, 0),('sam', '1', 1, 1),('yx', '2', 2, 8);
